...
namespace Homework3
{
    public partial class Form1 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e) //generate distribution button
        {
            ...
            distribution.Columns.Add("Length");
            distribution.Columns.Add("Frequency");

            dataGridView2.DataSource = distribution;

            foreach (var item in pkgLenght)
            {
                distribution.Rows.Add(item.Str, item.Count);
            }
        }
    }
}